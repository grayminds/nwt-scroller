...
class FlutterOverlayWindow {
  ...
  /// Enable or disable native custom drag for a left-zone of the overlay.
  /// Uses screen-space coordinates (getRawX/getRawY) to avoid feedback loop.
  static Future<bool?> setCustomDrag(bool enabled, int zoneWidthPx) async {
    final bool? _res = await _channel.invokeMethod<bool?>(
      'setCustomDrag',
      {'enabled': enabled, 'zoneWidthPx': zoneWidthPx},
    );
    return _res;
  }
